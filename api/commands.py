...
logging.basicConfig(filename='./logs/discord.log', level=logging.DEBUG, format='%(levelname)s %(asctime)s %(message)s')

nonDiscordLog = logging.getLogger('MyLogs')
handler = logging.FileHandler(filename='./logs/FormulaOneLogs.log', encoding='utf-8', mode='w')
