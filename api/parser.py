...
async def get_race_schedule_calendar():
...
async def get_season_team_standings(season):
...
async def get_season_driver_standings(season):
...
async def get_race_results(rnd, season, winner_only=False):
    ...
    if soup:
        ...
        return res
async def get_all_drivers_and_teams_for_season(season):
